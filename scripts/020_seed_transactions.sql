...
('aaaa0001-0001-0001-0001-000000000002', 'aaaa1111-1111-1111-1111-111111111111', 'debit', 4500.00, 20750.00, 'Rent Payment', 'Emaar Properties', 'housing', 'completed', 'RENT-NOV-24', NOW() - INTERVAL '5 days'),
...
-- Mohammed Ali's transactions (Current Account) - Fixed: aaaa2222-1111-2222-2222-222222222222 → aaaa2222-1111-1111-1111-111111111111
...
-- Emma Wilson's transactions - Fixed: aaaa3333-1111-3333-3333-333333333333 → aaaa3333-1111-1111-1111-111111111111
...
('aaaa0003-0001-0001-0001-000000000002', 'aaaa3333-1111-1111-1111-111111111111', 'debit', 3200.00, 350.00, 'Rent Share', 'Roommate Transfer', 'housing', 'completed', 'RENT-SHARE', NOW() - INTERVAL '5 days'),
...
-- Raj Patel's transactions (Private Banking) - Fixed: aaaa4444-1111-4444-4444-444444444444 → aaaa4444-1111-1111-1111-111111111111
...
-- Fatima Hassan's transactions - Fixed: aaaa5555-1111-5555-5555-555555555555 → aaaa5555-1111-1111-1111-111111111111
...
('aaaa0005-0001-0001-0001-000000000002', 'aaaa5555-1111-1111-1111-111111111111', 'debit', 5000.00, 10900.00, 'Rent', 'Al Wasl Properties', 'housing', 'completed', 'RENT-FH-11', NOW() - INTERVAL '5 days'),
